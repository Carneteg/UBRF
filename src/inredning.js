...
const INREDNING = (() => {
  ...
  const stall = [
    ...
    {id:"uppehall_soffa_s", rum:"uppehallsrum", typ:"soffa", pos:[2.35, U.y+0.55], rikt:N,
     matt:{b:1.85, d:0.85, h:0.70}, farg:"#1C1C1E", kolliderar:true,
     kalla:"stall-inne-01", klass:"VERIFIED", lage:"ASSUMPTION"},
    {id:"uppehall_bord_1", rum:"uppehallsrum", typ:"bord", pos:[1.65, 61.75], rikt:E,
     matt:{b:0.55, d:0.55, h:0.45}, farg:"#141416", kolliderar:true,
     kalla:"stall-inne-01", klass:"VERIFIED", lage:"ASSUMPTION"},
    {id:"uppehall_bord_2", rum:"uppehallsrum", typ:"bord", pos:[2.25, 61.75], rikt:E,
     matt:{b:0.55, d:0.55, h:0.45}, farg:"#141416", kolliderar:true,
     kalla:"stall-inne-01", klass:"VERIFIED", lage:"ASSUMPTION"},
    {id:"uppehall_ponny", rum:"uppehallsrum", typ:"ponny", pos:[3.9, 62.4], rikt:N,
