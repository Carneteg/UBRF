...
| Uteridbanan | 172 / 119,5 | kortsidan öst–väst | **33,57** `[VERIFIED]` × 48 `[REFERENCE GAP]` | Kortsidan är mätt. **Långsidan är inte det** — 48 m är en platshållare som ryms mellan gavellinjen y = 119 och tomtens djup 170, alltså ett mått på modellens ram och inte på UBRF. Ett första försök med 60 m sköt 88 delar utanför tomten. Avståndet till husen är också `[REFERENCE GAP]`. Staket, master, domarkur och torvbalar läser den här rektangeln. |
