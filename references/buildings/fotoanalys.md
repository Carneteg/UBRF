...
Byggnad: **$ARGUMENTS**. Mapp: `reference/buildings/$ARGUMENTS/`.
...
3. Kopiera `reference/buildings/_mall/KORT.md` till `reference/buildings/$ARGUMENTS/KORT.md` om kortet inte finns.
