...
saga(KRAVDA.every(id => ids.includes(id)) && ids.length === KRAVDA.length, `de tolv kamerorna i #78 + STALL-ANKOMST + STALL-UPPEHALL-SOFFA + de fyra ur reviewn 07:54 + RIDHUS-SKAPRUM (PO 11:56) + STALL-EFTER-PAUSRUM-V1/V2 (PO 15:15) finns, inga fler (${ids.length})`);
