...
python3 roblox/tests/build.py tests/klient.spec.luau && luau roblox/tests/.build/klient.spec.luau
...
- **GUI-layout.** `klient.spec.luau` mäter att rutorna inte krockar i
  skärmens koordinater. Att texten är läsbar och att inget skymmer hästen kan
  bara ses i Studio, av en människa.
