...
cd "$(dirname "$0")/.." || exit 1
SPECAR="geometri spel spelkanon forberedelse skotselpass integration roster sprak sprak-en bygge forstaplayable spelbarhet qa sikt movement camera rider touch genomsikt paritet ugneta ugneta-gestalt klient"
byggargs=""
