...
cd "$(dirname "$0")/.." || exit 1
SPECAR="geometri spel spelkanon forberedelse skotselpass integration ledning roster sprak sprak-en bygge mark handighet forstaplayable preflight tack hasthojd avsittning spelbarhet varldskoherens varldshud topologi qa sikt movement camera rider touch genomsikt paritet ugneta ugneta-gestalt klient mobillayout hastresan flerspelare pekridning utrustningsgrind utrustningspanel"
byggargs=""
