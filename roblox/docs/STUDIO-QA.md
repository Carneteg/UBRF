...
Samma nitton vyer som webbens screenshot-pack (`qa/visual-gate/kameror.json`),
...
Product Owner-reviewn 11:56: `RIDHUS-SKAPRUM`. Kameran står som spelets tredjepersonskamera: 3,6 m bakom
