# First Playable-place — källhead `b0265bb`
...
| | |
|---|---|
| källhead (source SHA) | `b0265bb41faf5bc7995ba56ca1d8fd87bf506bb3` |
| gren | `claude/first-playable-20260910`, bas `main` |
| fil | `UBRFFirstPlayable.rbxlx` |
| SHA256 | `f2f1d3ac332ec547238313f6734395d331403a883d7cde6041021468f9dab083` |
| storlek | 966 840 byte |
| instanser | 65 |
| bakad `ReplicatedStorage/UBRFBuild.sha` | `b0265bb41faf5bc7995ba56ca1d8fd87bf506bb3` |
