...
7. Kör bygg-, miljö-, geometri-, paritets- och relevanta gameplayregressioner. Falsifiera kritiska skydd. Skapa källkopplade före/efter-bilder från samma kameror och exakt ren produkt-SHA. Kontrollera faktiskt spelbar webbpreview på Vercel; Roblox-export/specs samt verkligt Studio-test redovisas separat. (Pektest på Roblox utgick 2026-09-13 — första playable är ett skrivbordsspel.)
