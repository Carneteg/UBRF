...
Kör det ordinarie fullständiga QA-flödet samt tre oberoende tester av riktig väg/navigering, ridning till lektionsslut och inmatning. Inga manuellt satta tillstånd får ersätta uppsittning i end-to-end-godkännandet. Kontrollera också att E-prompten försvinner efter uppsittning, att kamera inte orsakar oönskad sväng, att tangentbyte inte lämnar kvar input och att fokusförlust stoppar rörelse. Fysisk Roblox Studio och subjektiv game feel är NOT_TESTED. (Kravet på verklig iPad utgick 2026-09-13 — första playable är ett skrivbordsspel.) Ingen PRODUCT_ACCEPTED, main-merge eller publik launch innan blockerarna är stängda och Tobias godkänt spelkänslan.
