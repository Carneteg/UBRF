...
**Status:** `IMPLEMENTING` (checkpoint 1 av 5 pushad)
...
| 1 | Semantiska hjälper: inner-/yttertygel, vikt, paraden som egen signal | pushad |
| 2 | Hästens svar: fördröjning, känslighet, balans, fokus, spänning, energi | ej påbörjad |
